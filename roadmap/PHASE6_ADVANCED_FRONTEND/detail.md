...
## Week 1: Target Prediction (BTB & RAS)
- [ ] **Branch Target Buffer (BTB)**: A 2-level cache of target addresses.
...
- [ ] **Pre-fetcher**: Guessing the next line of code before it's even asked for.

...
| **[Phase 3](./PHASE3_MEMORY_EXTENSIONS/detail.md)** | **Memory & Extensions** | 2 Weeks | Load/Store Unit, Atomic, and Multiplication. |
...
| **[Phase 6](./PHASE6_ADVANCED_FRONTEND/detail.md)** | **Advanced Frontend** | 3 Weeks | TAGE, BTB, RAS, and I-Cache optimization. |
| **[Phase 7](./PHASE7_OUT_OF_ORDER/detail.md)** | **Out-of-Order Engine** | 4 Weeks | ROB, Rename, Issue Queues, Scoreboard. |
| **[Phase 8](./PHASE8_SYSTEM_PRIVILEGE/detail.md)** | **System & Privilege** | 3 Weeks | CSRs, Exceptions, MMU (Sv39). |
